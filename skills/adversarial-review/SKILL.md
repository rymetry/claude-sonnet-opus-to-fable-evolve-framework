...
description: "Fresh-context adversarial review of a finished deliverable — code, document, analysis, design, plan. Use when the user explicitly asks for a rigorous review ('adversarial-review', '敵対的レビュー', '徹底的にレビュー/検証して'), or before declaring any significant piece of work complete. NOT for casual or routine review requests (a quick look at a PR, running a build, verifying a single fact) — for those, review normally without this protocol. Also usable standalone on work produced elsewhere."
---
